...
const sideImage = 'https://images.unsplash.com/photo-1631945788919-24e76faead25?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80'
    ...
    <div className="w-full h-100">
      ...
      <form className="mt-6" onSubmit={submitHandler}>
        <div>
          ...
          <input type="email" name="email" placeholder="Enter Email Address" className="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autoFocus autoComplete="true" required />
        </div>
      ...
      <p className="mt-8">Need an account? <Link href="/sign-up" className="text-blue-500 hover:text-blue-700 font-semibold">Create an
              account</Link></p>
